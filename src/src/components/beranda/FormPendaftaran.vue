    ...
    <q-card>
      ...
      <q-card-section class="q-pt-none">
        <q-form @submit="submitForm" @reset="onReset" class="q-gutter-sm">
          ...
          <!-- Jenis Kelamin -->
          <div>
            <q-label class="text-grey-7">Jenis Kelamin*</q-label>
          ...
          <!-- Status Olahraga -->
          <div>
            <q-label class="text-grey-7">Status Olahraga*</q-label>
          ...
          <!-- Lama Cedera -->
          <div>
            <q-label class="text-grey-7">Lama Cedera*</q-label>
            <q-option-group :options="lama" type="radio" v-model="long" />
          </div>

          <!-- Sudah Berapakali diterapi -->
          <div>
            <q-label class="text-grey-7">Sudah Berapakali diterapi*</q-label>
  ...
  >
    <q-card>
      ...
      <q-card-section class="q-mt-xl">
        <q-flex justify="center" align="center" class="q-mt-xl">
    ...
    async submitForm() {
      ...
      try {
        ...
        const response = await axios.post(
          "http://localhost:8000/api/daftar/create",
          formData,
          {
            headers: {
